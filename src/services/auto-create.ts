...
3. 每章大纲必须50-80字，简洁明了，直击要点：场景+冲突+悬念，无废话
4. 章节标题：10字以内，不要编号（不要"第X章"），直接写标题，吸引眼球
5. 每章结尾必须有悬念或钩子
6. 有明确的"爽点循环"设计（每3-5章一个小高潮）
7. 章节之间要有逻辑连贯性
8. 注意角色的生死状态和人物关系，已故角色不应再出场
9. 🚫【严禁重复】如果提供了"本卷已写内容"，新章节必须从已写内容的结尾继续，绝不可重复已发生的情节、对话或场景

🔴【卷边界约束 - 极其重要】：
10. ⛔ 不得重复上一卷内容：如果提供了"上一卷已完成内容"，表示这些剧情、冲突、场景已经在上一卷完成。本卷必须开启新的故事线，不得重复上一卷的核心事件
11. ⛔ 不得提前写下一卷：如果提供了"下一卷内容预告"，表示这些剧情、事件属于下一卷。本卷不得涉及下一卷的关键事件、冲突、转折，只能埋伏笔
  ...
  "chapters": [
    {
      ...
      "title": "标题（10字内，无编号，无废话）",
      "outline": "简洁大纲，50-80字：场景+冲突+悬念，直击要点"
    }
  ]
}
